...
data/
  raw/               # raw trip CSVs (not committed)
  processed/         # cleaned trips and summary tables
src/
  clean_trips.py     # trip cleaning / feature engineering
  station_enrichment.py
  sql_upload.py
sql/
  schema.sql
  analysis_queries.sql
tableau/
  Oslo_Bike_Analysis.twbx
README.md